(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))n(t);new MutationObserver(t=>{for(const a of t)if(a.type==="childList")for(const c of a.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&n(c)}).observe(document,{childList:!0,subtree:!0});function s(t){const a={};return t.integrity&&(a.integrity=t.integrity),t.referrerpolicy&&(a.referrerPolicy=t.referrerpolicy),t.crossorigin==="use-credentials"?a.credentials="include":t.crossorigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function n(t){if(t.ep)return;t.ep=!0;const a=s(t);fetch(t.href,a)}})();let p;const f=new Uint8Array(16);function h(){if(!p&&(p=typeof crypto<"u"&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto),!p))throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");return p(f)}const i=[];for(let e=0;e<256;++e)i.push((e+256).toString(16).slice(1));function g(e,o=0){return(i[e[o+0]]+i[e[o+1]]+i[e[o+2]]+i[e[o+3]]+"-"+i[e[o+4]]+i[e[o+5]]+"-"+i[e[o+6]]+i[e[o+7]]+"-"+i[e[o+8]]+i[e[o+9]]+"-"+i[e[o+10]]+i[e[o+11]]+i[e[o+12]]+i[e[o+13]]+i[e[o+14]]+i[e[o+15]]).toLowerCase()}const S=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),_={randomUUID:S};function d(e,o,s){if(_.randomUUID&&!o&&!e)return _.randomUUID();e=e||{};const n=e.random||(e.rng||h)();if(n[6]=n[6]&15|64,n[8]=n[8]&63|128,o){s=s||0;for(let t=0;t<16;++t)o[s+t]=n[t];return o}return g(n)}let l={account_id:d(),current_balance:0,total_expenses:0,total_food:0,total_subscriptions:0,total_shop:0,total_entertainment:0,total_transport:0,total_house:0,investments_total:0,investments_fixed_income:0,investments_variable_income:0,investments_criptocurrencies:0,transactions:[]};localStorage.getItem("finances_account")&&(l=JSON.parse(localStorage.getItem("finances_account")));function r(e){return(e/100).toLocaleString("pt-br",{minimumFractionDigits:2})}function u(e){return e.toFixed(2)}function m(){let e=new Date().toLocaleDateString("pt-BR"),o=new Date().toLocaleTimeString("pt-BR");return`${e} ${o}`}function b(e){return e=e.replace("R$ ",""),e=e.replace(",",""),e=e.replace(".",""),Number(e)}const E=r(l.current_balance),y=r(l.total_expenses),T=r(l.investments_total),I=r(l.investments_fixed_income),x=u(l.investments_total?l.investments_fixed_income/l.investments_total*100:0),N=r(l.investments_variable_income),R=u(l.investments_total?l.investments_variable_income/l.investments_total*100:0),O=r(l.investments_criptocurrencies),$=u(l.investments_total?l.investments_criptocurrencies/l.investments_total*100:0),L=r(l.total_food),w=u(l.total_expenses?l.total_food/l.total_expenses*100:0),A=r(l.total_subscriptions),D=u(l.total_expenses?l.total_subscriptions/l.total_expenses*100:0),P=r(l.total_shop),q=u(l.total_expenses?l.total_shop/l.total_expenses*100:0),M=r(l.total_entertainment),F=u(l.total_expenses?l.total_entertainment/l.total_expenses*100:0),C=r(l.total_transport),U=u(l.total_expenses?l.total_transport/l.total_expenses*100:0),H=r(l.total_house),k=u(l.total_expenses?l.total_house/l.total_expenses*100:0);function B(e,o,s,n){e.addEventListener("click",()=>{if(console.log("totalDeposit => ",o.value),console.log("depositDescription => ",s.value),console.log("depositCategory => ",n.value),o.value&&s.value&&n.value){let t=JSON.parse(localStorage.getItem("finances_account"));const a=b(o.value);if(a<=0&&alert("Enter a valid deposit value greater than 0!"),a>0)if(t){t.current_balance+=a,t.transactions.push({id:d(),created_at:m(),updated_at:null,type:"DEPOSIT",category:n.value,description:s.value,total:a});let c=JSON.stringify(t);localStorage.setItem("finances_account",c)}else{t={account_id:d(),current_balance:0,total_expenses:0,total_food:0,total_subscriptions:0,total_shop:0,total_entertainment:0,total_transport:0,total_house:0,investments_total:0,investments_fixed_income:0,investments_variable_income:0,investments_criptocurrencies:0,transactions:[{id:d(),created_at:m(),updated_at:null,type:"DEPOSIT",category:n.value,description:s.value,total:a}]},t.current_balance+=a;let c=JSON.stringify(t);localStorage.setItem("finances_account",c)}}})}function V(){if(localStorage.getItem("finances_account")){let e=JSON.parse(localStorage.getItem("finances_account"));if(e.transactions.reverse(),console.log(e.transactions),!e.transactions)return"No transactions available";let o="";for(let s=0;s<e.transactions.length;s++){let n=e.transactions[s].type==="DEPOSIT"?"text-success":e.transactions[s].type==="EXPENSE"?"text-danger":"text-primary";o+=`
				<li class="list-group-item list-group-item-action d-flex justify-content-between">
					<div class="me-auto">
						<h5 class="fw-bold ${n}">${e.transactions[s].description}</h5>
						<small>${e.transactions[s].created_at}</small>
						<br>
						<small>${e.transactions[s].category}</small>
					</div>
					<div class="ms-auto">
						<h5 class="fw-bold ${n}">+ R$ ${r(e.transactions[s].total)}</h5>
			...
			`}return o}else return"No transactions available"}const J=V();function G(e,o,s,n){e.addEventListener("click",()=>{if(console.log("totalInvestment => ",o.value),console.log("investmentDescription => ",s.value),console.log("investmentCategory => ",n.value),o.value&&s.value&&n.value){let t=JSON.parse(localStorage.getItem("finances_account"));const a=b(o.value);if(a<=0&&alert("Enter a valid investment value greater than 0!"),a>0)if(t)if(a<=t.current_balance){t.current_balance-=a,t.investments_total+=a,n.value==="FIXED_INCOME"&&(t.investments_fixed_income+=a),n.value==="VARIABLE_INCOME"&&(t.investments_variable_income+=a),n.value==="CRIPTOCURRENCIES"&&(t.investments_criptocurrencies+=a),t.transactions.push({id:d(),created_at:m(),updated_at:null,type:"INVESTMENT",category:n.value,description:s.value,total:a});let c=JSON.stringify(t);localStorage.setItem("finances_account",c)}else alert("You dont have sufficient balance to make this investment!");else{t={account_id:d(),current_balance:0,total_expenses:0,total_food:0,total_subscriptions:0,total_shop:0,total_entertainment:0,total_transport:0,total_house:0,investments_total:0,investments_fixed_income:0,investments_variable_income:0,investments_criptocurrencies:0,transactions:[{id:d(),created_at:m(),updated_at:null,type:"INVESTMENT",category:n.value,description:s.value,total:a}]},t.current_balance-=a,t.investments_total+=a,n.value==="FIXED_INCOME"&&(t.investments_fixed_income+=a),n.value==="VARIABLE_INCOME"&&(t.investments_variable_income+=a),n.value==="CRIPTOCURRENCIES"&&(t.investments_criptocurrencies+=a);let c=JSON.stringify(t);localStorage.setItem("finances_account",c)}}})}function X(e,o,s,n){e.addEventListener("click",()=>{if(console.log("totalExpense => ",o.value),console.log("expenseDescription => ",s.value),console.log("expenseCategory => ",n.value),o.value&&s.value&&n.value){let t=JSON.parse(localStorage.getItem("finances_account"));const a=b(o.value);if(a<=0&&alert("Enter a valid expense value greater than 0!"),a>0)if(t)if(a<=t.current_balance){t.current_balance-=a,t.total_expenses+=a,n.value==="FOOD"&&(t.total_food+=a),n.value==="SUBSCRIPTION"&&(t.total_subscriptions+=a),n.value==="SHOP"&&(t.total_shop+=a),n.value==="ENTERTAINMENT"&&(t.total_entertainment+=a),n.value==="TRANSPORT"&&(t.total_transport+=a),n.value==="HOUSE"&&(t.total_house+=a),t.transactions.push({id:d(),created_at:m(),updated_at:null,type:"EXPENSE",category:n.value,description:s.value,total:a});let c=JSON.stringify(t);localStorage.setItem("finances_account",c)}else alert("You dont have sufficient balance to make this expense!");else{t={account_id:d(),current_balance:0,total_expenses:0,total_food:0,total_subscriptions:0,total_shop:0,total_entertainment:0,total_transport:0,total_house:0,investments_total:0,investments_fixed_income:0,investments_variable_income:0,investments_criptocurrencies:0,transactions:[{id:d(),created_at:m(),updated_at:null,type:"EXPENSE",category:n.value,description:s.value,total:a}]},t.current_balance-=a,t.total_expenses+=a,n.value==="FOOD"&&(t.total_food+=a),n.value==="SUBSCRIPTION"&&(t.total_subscriptions+=a),n.value==="SHOP"&&(t.total_shop+=a),n.value==="ENTERTAINMENT"&&(t.total_entertainment+=a),n.value==="TRANSPORT"&&(t.total_transport+=a),n.value==="HOUSE"&&(t.total_house+=a);let c=JSON.stringify(t);localStorage.setItem("finances_account",c)}}})}document.querySelector("#navbar").innerHTML=`
