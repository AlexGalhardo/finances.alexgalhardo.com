...
class TransactionsController {
    async getAllTransactions(req, res) {
        const allTransactions = await new _getAllTransactionsUseCase.default((0, _getTransactionsRepository.getTransactionsRepository)()).execute((0, _decodeJwtToken.getDecodedJwtToken)(req).userId);
    ...
    async createTransaction(req, res) {
        ...
        const response = await new _createTransactionUseCase.default((0, _getTransactionsRepository.getTransactionsRepository)()).execute({
            user_id: (0, _decodeJwtToken.getDecodedJwtToken)(req).userId,
            type,
            category,
            description,
            amount
